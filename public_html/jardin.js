 ...
 if(document.getElementById('articulos')) {
    ...
    function crearTabla(data) {
                    ...
                    for (i = 0; i < data.split(/\r\n|\r|\n/).length-1; i++) {
                       ...
                       celdas="<td id='imagen"+i+"'class='imagen'><img src='http://www.vetusplas.com/images/webcli/peque/"+refImg+".png' onclick=ampliarImg("+refImg+";)></img></td>";
                       ...
                       celdas=celdas+"<td id='cantidad"+i+"'class='cantidad'>"+"<input type='number' name='cantidad' placeholder='cantidad' value='0' onmouseover=calcular("+ cantidadPorCaja+","+ valorUnidad+"," +i+",this); onmouseout=calcular("+ cantidadPorCaja+","+ valorUnidad+"," +i+",this); ></td>";
...
function calcular(num1, num2, linea, num3){
                       ...
                       resultadoTotalJardin=eval(resultadoTotalJardin+resultado);
...
function calcularTotal(){
    ...
    total =eval(resultadoTotalJardin + resultadoTotalMenaje + resultadoTotalLimpieza);
